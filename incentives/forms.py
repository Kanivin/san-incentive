...
class IncentiveSetupForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'domestic_lead_source','domestic_deal_owner', 'domestic_follow_up', 'domestic_demo_1', 'domestic_demo_2',
            'international_lead_source','international_deal_owner', 'international_follow_up', 'international_demo_1', 'international_demo_2',
        ...
        widgets = {
            ...
            'domestic_deal_owner': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'domestic_lead_source': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'domestic_follow_up': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'domestic_demo_1': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'domestic_demo_2': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'international_deal_owner': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'international_lead_source': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'international_follow_up': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'international_demo_1': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
            'international_demo_2': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
